...
def models(x_train, y_train):
  ...
  tree = DecisionTreeClassifier(max_depth=5,random_state =61)
  tree.fit(X_train, y_train)


  xgBoost = GradientBoostingClassifier(learning_rate = 0.035,
                                       random_state = 61,
                                        max_depth = 10,n_estimators=40, min_samples_leaf=3,
                                        min_samples_split=2,)
  xgBoost.fit(X_train,y_train)


  classifier_rf = RandomForestClassifier(max_depth=5,random_state = 61,
...
import pickle
with open('AGPrediction_XGBoost','wb') as f:
